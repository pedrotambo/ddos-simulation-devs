...
-- Le llega que apague el servidor 2, que está en busy, espera a que lo termine.
-- Le llega que el servidor 2 terminó el job, lo apaga.
-- Le llega que apague el servidor 2, excepción! Ya estaba apagado
